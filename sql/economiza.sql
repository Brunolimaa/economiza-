...
--
-- Host: 127.0.0.1
-- Generation Time: 06-Set-2017 às 04:59
...
--
-- Extraindo dados da tabela `cad_desc`
--
...
--
-- Extraindo dados da tabela `cad_endereco`
--
...
--
-- Estrutura da tabela `cad_mercado`
--
...
--
-- Extraindo dados da tabela `cad_mercado`
--
...
--
-- Extraindo dados da tabela `cad_preco`
--
...
--
-- Estrutura da tabela `cad_prod_categoria`
--
...
--
-- Extraindo dados da tabela `cad_prod_categoria`
--
...
--
-- Estrutura da tabela `cad_promocao`
--
...
--
-- Extraindo dados da tabela `cad_promocao`
--
...
--
-- Indexes for table `cad_prod_categoria`
--
...
--
-- Indexes for table `cad_promocao`
--
...
--
-- AUTO_INCREMENT for table `cad_desc`
--
ALTER TABLE `cad_desc`
  MODIFY `id_desc` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=8;
--
-- AUTO_INCREMENT for table `cad_mercado`
--
ALTER TABLE `cad_mercado`
...
--
-- AUTO_INCREMENT for table `cad_prod_categoria`
--
ALTER TABLE `cad_prod_categoria`
